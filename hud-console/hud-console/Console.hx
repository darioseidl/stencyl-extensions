...
/**
 * ...
 * @author This class version is made by captaincomic; original version: Fernando Medina.
 * This class is made by Fernando Medina, see my blog for more tools: http://fermmm.wordpress.com/
 * Some methods and helper classes are from MLC project.
 * 
...
class Console 
{
	private static inline var VERSION:String = "1.1.1";
	/**
	...
	private static var commands				:Map<Dynamic>;
	...
	private static var liveDataFields		:Map<Bar>;
	private static var chronometers			:Map<Chronometer>;
	 ...
	 */
	public static function create(catchTrace:Bool = true, toggleKeyCode:Int = 49, withControlKeyPressed:Bool = true, showWelcomeMessege:Bool = true) 
	{
		created 			= true;
		...
		commands 			= new Map<Dynamic>();
		liveDataFields 		= new Map<Bar>();
		chronometers 		= new Map<Chronometer>();
	...
	public static function refreshSize():Void
	{
		onResize();
	}
	...
	private static function printHelp(par:String = null):Void
	{
		ConsoleText.write("//////////////////////////////////////////////////////////");
		ConsoleText.write(" ");
		ConsoleText.write("Console version: " + VERSION + " by fermmm", 0xDAE2A7);
		ConsoleText.write("http://fermmm.wordpress.com/", 0xDAE2A7);
		ConsoleText.write(" ");
		ConsoleText.write("Use up and down keys to navigate the input history.");
	...
	/**
	* Copyright (c) 2009-2012, Fernando Medina, Pimm Hogeling, Edo Rivai.
	*/
...
/**
 * Copyright (c) 2009-2012, Pimm Hogeling, Edo Rivai.
 * 
